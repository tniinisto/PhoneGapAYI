...
function validateForm() {
    ...
    if($("#comment_input").val() != '') {
        ...
        //Just noew - add your comment to the list top
        ...
        //     + "<p style='font-size: 90%; text-transform: none; color: white; display: inline-block; margin-left: 15px; vertical-align: top; margin-top: 15px; '>" + sessionStorage['pname'] + ", just now...</p>"
