...
function getEvents(teamid, afterlogin=0) {
    ...
    data: {'teamid': teamid, 'timezone': sessionStorage['timezone']},
        ...
        success:function(result){
            ...
            if(licenseValid < today5 && (sessionStorage['admin'] == 1 || sessionStorage['registrar'] == 1)) {
                               
                //License old
                if(licenseValid < today) {
                ...
                } else { //Still time to activate before getting old
            ...
            if(areyouin[0][0] == 0) {
                ...
                //Admin & Registrar info for scheduling a new event
                if(sessionStorage['admin'] == 1 || sessionStorage['registrar'] == 1) {
                    ...
                    $("#event_content_id" ).append(
                        ...
                        "<div style='text-align:center; padding-bottom: 2em; margin-top: 1em; background: #39414b; height: auto; width: auto; padding-top: 1em;'>"
                            ...
                            + "<div style='padding-left: 5px; padding-right: 5px;'><button><a style='text-transform: none; text-decoration: underline; font-size: 100%; color: #2ad;' onclick='loadWebURL();'>Schedule a new event from web</a></button></div>"
                    ...
                    "<div style='text-align:center; padding-bottom: 2em; margin-top: 1em; background: #39414b; height: auto; padding-top: 1em;'>"
                        ...
                        + "<h1 style='style='font-size: 110%; font-weight: bold; color: lightgrey;' id='eventstatus_0' style='background: #39414b; margin-top: -15px;'>No events scheduled at the moment...</h1>"
...

            {
                ...
                while( areyouin[i][0] != 0 ) {
                    ...
                    if(areyouin[i][7] == 0 || areyouin[i][7] == 2 || sessionStorage['admin'] == 1 || sessionStorage['registrar'] == 1) {
